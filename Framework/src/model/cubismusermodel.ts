...
import { CubismModelSynchronizer } from './cubismModelSynchronizer';
...
export class CubismUserModel {
  ...
  // wsm
  public setModel(model: Live2DCubismCore.Model) {
    this._model = new CubismModel(CubismModelSynchronizer.setup(model));
